...
namespace FMScoutFramework.Core.Entities.GameVersions
{
	...
	internal class Steam_16_2_0_Linux : IIVersion
	{
		...
		public bool SupportsProcess(FMProcess process, byte[] context)
		{
			...
			process.VersionDescription = "16.2.0 750458 (m.e v1630)";
			return true;
			#endif
		}
		...
		{
			public int MainAddress { get { return 0xae8af84; } }
			public int MainOffset { get { return 0x0; } }
			public int XorDistance { get { return 0x5C; } }
			...
			public int CurrentDateTime { get { return 0xae7a9a0; } }
		}
