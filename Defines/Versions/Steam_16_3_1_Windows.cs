...
namespace FMScoutFramework.Core.Entities.GameVersions
{
    ...
    internal class Steam_16_3_1_Windows : IIVersion
    {
        ...
        {
            public int MainAddress { get { return 0x02571688; } }
            ...
            public int CurrentDateTime { get { return 0x0255CC9A; } }
        }
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers
        {
            ...
            public int HumanManager { get { return 0x02776720; } } // Done
            public int Official { get { return 0x02781AA8; } } // Done
            public int RetiredPerson { get { return 0x0251E478; } } // Done
