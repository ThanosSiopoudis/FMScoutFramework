...
namespace FMScoutFramework.Core.Entities.GameVersions
{
    ...
    internal class Steam_15_3_2_Windows : IIVersion
    {
...
#if WINDOWS
            if (process.VersionDescription != "15.3.2f627042") return false;
        ...
        {
            public int MainAddress { get { return 0x1A8484E; } }
            ...
            public int CurrentDateTime { get { return 0x1F9EBF4; } }
        }
